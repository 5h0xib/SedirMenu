...
myApp.service('DataService', ['$http', function ($http) {
    ...
    this.getHomeMade = function () {
        return $http.get('data/bevrages/homeMade.json');
    };
    this.getMilkShakes = function () {
        return $http.get('data/bevrages/milkShakes.json');
    };
    this.getMocktails = function () {
        return $http.get('data/bevrages/mocktails.json');
    };
    this.getMojithos = function () {
        return $http.get('data/bevrages/mojithos.json');
    };
    this.getProteinShakes = function () {
        return $http.get('data/bevrages/proteinShakes.json');
    };
    this.getSmoothis = function () {
        return $http.get('data/bevrages/smoothis.json');
    };
    this.getSoftDrinks = function () {
        return $http.get('data/bevrages/softDrinks.json');
    };
    this.geticedCoffees = function () {
        return $http.get('data/bevrages/icedCoffees.json');
    };
    this.gethotCoffees = function () {
        return $http.get('data/bevrages/hotCoffees.json');
    };
    this.getTeas = function () {
        return $http.get('data/bevrages/teas.json');
    };

    // Food
    this.getAppetizers = function () {
        return $http.get('data/food/appetizers.json');
    };
    this.getBreakFast = function () {
        return $http.get('data/food/breakFast.json');
    };
    this.getBurgers = function () {
        return $http.get('data/food/burgers.json');
    };
    this.getKidsMenu = function () {
        return $http.get('data/food/kidsMenu.json');
    };
    this.getMainCourse = function () {
        return $http.get('data/food/mainCourse.json');
    };
    this.getPasta = function () {
        return $http.get('data/food/pasta.json');
    };
    this.getPizza = function () {
        return $http.get('data/food/pizza.json');
    };
    this.getSalads = function () {
        return $http.get('data/food/salads.json');
    };
    this.getSoups = function () {
        return $http.get('data/food/soups.json');
    };
    this.getTurkishPide = function () {
        return $http.get('data/food/turkishPide.json');
    };
    this.getWraps = function () {
        return $http.get('data/food/wraps.json');
    };

    // Sweets
    this.getDeserts = function () {
        return $http.get('data/sweets/Deserts.json');
    };
    this.getFruits = function () {
        return $http.get('data/sweets/fruits.json');
    };
...
myApp.controller('AppController', ['$scope', 'DataService', 'FavoritesService', function ($scope, DataService, FavoritesService) {
    ...
    loadCategory(DataService.getMainCourse, 'MainCourse');
    loadCategory(DataService.getAppetizers, 'Appetizers');
    loadCategory(DataService.getBurgers, 'Burgers');
    loadCategory(DataService.getKidsMenu, 'KidsMenu');
    loadCategory(DataService.getPasta, 'Pasta');
    loadCategory(DataService.getPizza, 'Pizza');
    loadCategory(DataService.getSalads, 'Salads');
    loadCategory(DataService.getSoups, 'Soups');
    loadCategory(DataService.getTurkishPide, 'TurkishPide');
    loadCategory(DataService.getWraps, 'Wraps');

    // Beverages
    loadCategory(DataService.getHomeMade, 'HomeMade');
    loadCategory(DataService.getMilkShakes, 'MilkShakes');
    loadCategory(DataService.getMocktails, 'Mocktails');
    loadCategory(DataService.getMojithos, 'Mojithos');
    loadCategory(DataService.getProteinShakes, 'ProteinShakes');
    loadCategory(DataService.getSmoothis, 'Smoothis');
    loadCategory(DataService.getSoftDrinks, 'SoftDrinks');
    loadCategory(DataService.gethotCoffees, 'hotCoffees');
    loadCategory(DataService.geticedCoffees, 'icedCoffees');
    loadCategory(DataService.getTeas, 'Teas');

    // Sweets
    loadCategory(DataService.getDeserts, 'Deserts');
    loadCategory(DataService.getFruits, 'Fruits');
